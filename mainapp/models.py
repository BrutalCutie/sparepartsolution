...
class Message(models.Model):
    ...
    readed = models.BooleanField(verbose_name="признак просмотрености", default=False)
...
class Request(models.Model):
    ...
    created_at = models.DateTimeField(auto_now_add=True, verbose_name="время создания заявки", null=True)
...
class Chat(models.Model):
    ...
    last_updated = models.DateTimeField(verbose_name="дата последнего обновления", auto_now=True, null=True)
...
class Review(models.Model):
    ...
    reviewer = models.ForeignKey(
        "users.User", verbose_name="ревьювер", related_name="writed_reviews", on_delete=models.CASCADE
    )
